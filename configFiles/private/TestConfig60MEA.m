...
ops.nt0                 = 37; %spike template time bins, it has to be an odd number!
ops.nt0min              = 12;
...
ops.Th               = [3 6 6];  % threshold for detecting spikes on template-filtered data, (suggested values were [4 10 10], )
