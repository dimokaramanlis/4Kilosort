...
ops.Nfilt               = 32*16;  % number of clusters to use (2-4 times more than Nchan, should be a multiple of 32)     		
ops.nNeighPC            = 12; % visualization only (Phy): number of channnels to mask the PCs, leave empty to skip (12)		
ops.nNeigh              = 16; % visualization only (Phy): number of neighboring templates to retain projections of (16)		
ops.fs                  = 2.5e4; %sampling frequency		
%==========================================================================		
...
ops.nt0                 = 61; %spike template time bins, it has to be an odd number!
ops.nt0min              = 20;
...
ops.Th               = [4 8 8];  % threshold for detecting spikes on template-filtered data, (suggested values were [4 10 10], )
ops.lam              = [10 40 40];   % large means amplitudes are forced around the mean, (suggested values were [5 20 20], [10 30 30])		
